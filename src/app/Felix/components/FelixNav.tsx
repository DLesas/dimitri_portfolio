...
export default function FelixNav() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-background/50 backdrop-blur-md border-t border-default-200 shadow-lg">
          <div className="max-w-screen-sm mx-auto px-2 pb-safe">
            <div className="flex items-center justify-around gap-1 py-2">
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center gap-0.5 px-4 py-1.5 rounded-lg transition-all duration-200 min-w-[90px] ${
                  isHome
              ...
              >
                ...
                <span className={`text-[10px] font-medium ${isHome ? 'font-semibold' : ''}`}>
                  Case Study
                </span>
              </button>
              ...
              >
                ...
                <span className={`text-[10px] font-medium ${isDemo ? 'font-semibold' : ''}`}>
                  Live Demo
                </span>
              </button>
            </div>
